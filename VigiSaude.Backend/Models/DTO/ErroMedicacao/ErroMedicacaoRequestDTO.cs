...
{
    public class ErroMedicacaoRequestDTO : IncideneteDto
    {
        public List<MedicamentoErroMedicacaoRequestDTO>? Medicamentos { get; set; }
    }

    public class MedicamentoErroMedicacaoRequestDTO
    {
